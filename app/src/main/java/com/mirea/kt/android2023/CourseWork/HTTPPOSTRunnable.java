...
public class HTTPPOSTRunnable implements Runnable{
    ...
    public HTTPPOSTRunnable(String address, HashMap<String, String> requestBody) {
        ...
        if(requestBody != null && !requestBody.isEmpty()){
            ...
            for(String key:this.requestBody.keySet()){
                try {
                    ...
                    System.out.println(" Ошибка в хттп руннабле генератеСтрирнгБуди");
                }
                i++;
            }
        }
    ...
    public void run() {
        if(this.address != null && !this.address.isEmpty()){
            try{
                ...
                System.out.println("Ошибка в хттп руннабле" + e.getMessage());
            }
        }
    }
}
